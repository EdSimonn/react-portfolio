            ...
            <div className="c-wrapper">
                ...
                <div className="c-right">
                    ...
                    <form ref={formRef} onSubmit={handleSubmit}>
                        ...
                        <textarea style={{backgroundColor: darkMode && "white"}} rows="5" placeholder="Message" name="message"></textarea>
...
// e.preventDefault() prvnts th pag from rloading if submit is clickd without an input